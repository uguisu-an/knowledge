...
[社内勉強会で生成 AI について発表したので 70 ページの資料を公開する！ #ChatGPT - Qiita](https://qiita.com/hedgehog051/items/b1308e8baf7b0f551548)

最初は簡単に試せる AutoML などを使ってベースラインを決めるのが定石。
[君には今から 3 時間で機械学習 Web アプリを作ってもらうよ](https://zenn.dev/alivelimb/articles/20220528-streamlit-ml-app)

学習手順: 微積 → 線形代数 → 統計 →（多変量解析 →）機械学習
