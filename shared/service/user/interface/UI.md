...
ドメインモデルやデータモデルが汚ければ画面も汚くなる。

ユーザーのUIはユーザーの都合に、システム担当者のUIはシステム担当者の都合に合わせる。

横長の表には行ホバーや奇数行で色を変えると、行を区別しやすくなる。

ユーザーインタフェースの設計とかの話は、設計の下よりも製品の下にあった方がいい。ユーザーインタフェースそのものの話で足りる。

https://note.com/uxakachan/n/n912fb2a9cce1

UIの基礎は「ユーザーが情報にアクセスする」ということ。

UIを一からちまちま作るのはめんどくさい。ここはAIで一気に作ってしまったほうがいいか。
