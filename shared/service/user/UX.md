...
ABテストをする前に、まずはいちいちABテストをしなくてもいいくらい大きな差がある施策から始める。ABテストが必要なのは小さな改善を繰り返す段階になってから。

UXには製品だけじゃなくてそれを手に入れるまでの流れや手に入れた後のサポートなども含まれる。顧客体験と同じものと考えるべき。

ページの読み込みは早ければ早いほどいい。
読み込みが遅くなるほど、ページが読み込まれる前にユーザーがページを閉じる可能性も大きくなる。
