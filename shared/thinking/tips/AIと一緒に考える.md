...
専門外の分野も AI の補助で一気に学習できるようになってきた。

今後は AI で作られた平凡なオーダーメイドが溢れる時代になる。

ソースコードなど、平凡でいいものは AI の得意分野。

分析を任せるのは結構 AI が強い分野。

苦手なところは AI に任せられるといい。

AI を特定の要素に絞って簡単な入力で目的のものを作れるのが便利。ロゴとか。

AIに指示を出すには、作業者というよりも、監督者の視点が必要。

AIに競馬や投資を任せるなら、勝率だけでなく期待値を計算させて、勝つか負けるかよりもいくら賭けるべきかを考えさせた方がいい。

AIに相談するときは、「最高の回答をするために必要なことはどんな些細なことでも質問してから回答してください」とするとまず質問を挟んでくれる。
