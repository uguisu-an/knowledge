...
格闘ゲームで「弱体化しろ」と愚痴を言うのは雑談ならいいけど、本番でも言ってる人は勝てない。

格闘ゲームでは見てからガードできない技を区別する。人によって反射速度は違うので、人によって対応する動きも違う。

格闘ゲームは極論、触られないように触る、攻めを重ねる、攻めを切る、の 3 つの動きしかない。攻めのターンの奪い合い。
攻めのターンが長いほど勝ちやすい。コンボミスは攻めが切れるし、対空されたりすると相手に攻めのターンを取られることがあるのでよくない。
体力はあくまでもリソースで、相手を攻めつぶすまでに体力分しかダメージを食らえない。例えば、対空されてもダメージだけで相手にターンを奪われないなら飛んで対空されてもコストを払っただけで、他の方法を試せばいい。

体力もリソースでしかない。
体力が少なくなると選べる選択肢が減る。

タイムアウトが少ないゲームなら、体力差は気にしなくてもいい。

ポイントが伸びなくなったら対戦ではなく学習と練習が必要。
対戦はよくある場面の練習にはなるけど、細かい精度を伸ばしたり新しい動きを覚えたりするのには向いていない。

初心者同士の対戦で有利不利とか関係ないので不利になる技も

コマ投げやスライディングが当たるのはリスクリターンが合ってないから。
当たっといて後で取り返せばいいと思われているので、当たっているから使ってもいいというわけではない。むしろ当たっている時ほど大事な場面では使わないのが相手の予想を外す。

ケンや JP のように攻めの時間が長いキャラも強いし、マリーザやディージェイのように短い時間で火力が出るキャラも強い。

格闘ゲームの面白いところは読み合いだけど、手札を揃えないとその段階にたどり着けない。
ある程度上手くならないとなかなか勝てずに楽しみが続かないのは競技性の高いゲームの難しいところ。

反射神経が 250ms の人と 150ms の人では 6F の差がある。
とはいえ、反射神経はあった方がいいけど、ないとダメっていうほどではないと思う。

格ゲーにおける殺意は前に出ることではなく、倒し切るための選択肢を選ぶことだ。

やることはシンプルで、練習よりも実践で覚えたほうがいいキャラと、やることが複雑で、とにかくトレモで練習する必要があるキャラがいる。
